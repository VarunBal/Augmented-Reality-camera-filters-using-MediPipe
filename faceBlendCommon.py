  ...
  with mp_face_mesh.FaceMesh(
      ...
      for face_landmarks in results.multi_face_landmarks:
          ...
          for i in range(len(values)):
              face_keypnts[i][0] = values[i].x
              face_keypnts[i][1] = values[i].y

          # print(face_keypnts[0])
          ...
          for i in keypnt_68:
              sixty_eight_keypnts.append(face_keypnts[i])
          sixty_eight_keypnts = dlibLandmarksToPoints(sixty_eight_keypnts)
          # print('*'*100)
          # print('\n\n')
          # print(sixty_eight_keypnts)
          # print('*'*100)
          # print('\n\n')
          return sixty_eight_keypnts         
  return 0
  # points = []
